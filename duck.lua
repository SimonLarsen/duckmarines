...
function Duck.create(x, y, dir)
	...
	self.anim[1] = Animation.create(ResMgr.getImage("duck_right.png"), 32, 38, 16, 28, 0.09, 8)
	self.anim[2] = Animation.create(ResMgr.getImage("duck_front.png"), 34, 37, 17, 26, 0.09, 6)
	self.anim[3] = Animation.create(ResMgr.getImage("duck_left.png"),  32, 38, 16, 28, 0.09, 8)
